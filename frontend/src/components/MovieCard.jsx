...
const MovieCard = ({ runtime, imdbRating, title, imdbID, poster }) => {
  ...
  return (
    <a href={`https://www.imdb.com/title/${imdbID}`} target="_blank" rel="noopener noreferrer">
      <div
        className={`cursor-pointer bg-green-100 group overflow-hidden bg-cover bg-center h-[13.5rem] min-[375px]:h-[15rem] md:h-[20rem] aspect-[2/3] lg:h-[17rem] rounded-md shadow-lg flex items-end relative`}
      >
